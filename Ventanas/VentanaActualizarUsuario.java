...
public class VentanaActualizarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new ImageIcon(getClass().getResource("/Imagenes/bienvenido.png"))); // NOI18N
        ...
        jLabel4.setIcon(new ImageIcon(getClass().getResource("/Imagenes/fondoGris.jpg"))); // NOI18N
        ...
        jLabel7.setIcon(new ImageIcon(getClass().getResource("/Imagenes/logoUnivallePeq.png"))); // NOI18N
        jPanelUsuario.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, -1, -1));

        jLabel8.setIcon(new ImageIcon(getClass().getResource("/Imagenes/logoLesPeq.png"))); // NOI18N
        jPanelUsuario.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 0, -1, -1));

        jLabel9.setIcon(new ImageIcon(getClass().getResource("/Imagenes/logoLabPeq.png"))); // NOI18N
        ...
        jPanelUsuario.add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 110, 30));
        ...
        jPanelUsuario.add(jLabelNickName, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, -1, 30));
        ...
        jPanelUsuario.add(jTextFieldNickName, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, 130, 30));
        ...
        jLabelFondo2.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Fondo.jpg"))); // NOI18N
