...
public class VentanaActualizarEquipos extends javax.swing.JFrame {


    EquipmentController objEquipmentCtrl;

    public VentanaActualizarEquipos() {//Subir a inte
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanelSolicitud.add(jLabelDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, -1, 30));
        ...
        jPanelSolicitud.add(jLabelCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, -1, -1));

        jLabelSolicitud.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabelSolicitud.setForeground(new java.awt.Color(102, 102, 102));
        jLabelSolicitud.setText("ACTUALIZAR EQUIPO");
        ...
        jPanelSolicitud.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 270, 60));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanelSolicitud.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 170, 30));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanelSolicitud.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, 170, 30));

        jLabelCodigo1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabelCodigo1.setForeground(new java.awt.Color(102, 102, 102));
        jLabelCodigo1.setText("SERIAL");
        jPanelSolicitud.add(jLabelCodigo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaActualizarEquipos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaActualizarEquipos().setVisible(true);
            }
        });
    }
